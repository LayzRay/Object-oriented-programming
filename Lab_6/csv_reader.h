...
public:
    ...
    virtual Abstract_reader& operator >> (Employee& current_employee) = 0;
...
public:
  ...
  virtual CSV_reader& operator >> (Employee& current_employee) override;
   virtual operator bool() override {return !(this->class_file.eof());}
...
public:
    ...
    virtual JSON_reader& operator >> (Employee& current_employee) override;
     virtual operator bool() override {return !(this->class_file.eof());}
